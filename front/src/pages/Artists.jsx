    ...
    <div className="container">
      <div className="artists">
        <div className="wrapper">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione similique enim natus, dicta quis sed magni. Tempora quod voluptatem aspernatur magnam quaerat asperiores, sed nostrum. Blanditiis itaque quibusdam laboriosam consequuntur!</p>
        </div>
      </div>
    </div>
    </>
